# Downloaded from the autojump directory:
#     https://raw.githubusercontent.com/wting/autojump/master/bin/autojump.zsh
# The autojump binary is provided by autojump-rs
